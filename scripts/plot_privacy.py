...
def init_wandb():
    wandb.init(project='report', name='privacy_fed')
...
def main():
    fed = {}
    with open(f'tested_privacy_{TAG}_client_0.pkl', 'rb') as f:
        fed[0] = pkl.load(f)

    with open(f'tested_privacy_{TAG}_client_1.pkl', 'rb') as f:
        fed[1] = pkl.load(f)     
        
    with open(f'tested_privacy_{TAG}_client_2.pkl', 'rb') as f:
        fed[2] = pkl.load(f)  

    with open(f'tested_privacy_{TAG}_client_3.pkl', 'rb') as f:
        fed[3] = pkl.load(f)  

    with open(f'tested_privacy_{TAG}_client_4.pkl', 'rb') as f:
        fed[4] = pkl.load(f)  
        
    with open(f'tested_privacy_{TAG}_client_5.pkl', 'rb') as f:
        fed[5] = pkl.load(f)  
        
    with open(f'tested_privacy_{TAG}_client_6.pkl', 'rb') as f:
        fed[6] = pkl.load(f)  

    with open(f'tested_privacy_{TAG}_client_7.pkl', 'rb') as f:
        fed[7] = pkl.load(f)  
