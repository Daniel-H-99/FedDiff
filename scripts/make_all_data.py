...
def main():
    root = '/home/server36/minyeong_workspace/FL-bench/data/cifar10_niid3/raw'
    cid_list = list(range(5))
    try:
        indices = pkl.load(open('/home/server36/minyeong_workspace/FL-bench/data/cifar10_niid3/indices.pkl', 'rb'))
    except:
        partition = pkl.load(open('/home/server36/minyeong_workspace/FL-bench/data/cifar10_niid3/partition.pkl', 'rb'))
