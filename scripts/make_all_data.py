...
def main():
    root = '/home/server32/minyeong_workspace/FL-bench/data/cifar10_iid/raw'
    cid_list = list(range(5))
    try:
        indices = pkl.load(open('/home/server32/minyeong_workspace/FL-bench/data/cifar10_iid/indices.pkl', 'rb'))
    except:
        partition = pkl.load(open('/home/server32/minyeong_workspace/FL-bench/data/cifar10_iid/partition.pkl', 'rb'))
    ...
    # all_train_dir = os.path.join(root, 'all_5000', 'train')
    # all_test_dir = os.path.join(root, 'all_5000', 'test')
