...
class FedDiffClient:
    ...
    def load_train_dataset(self, e):
        ...
        self.trainset.indices = np.concatenate([self.trainset.indices] * 25)[st: st + L]
    ...
    def set_parameters(self, new_parameters: OrderedDict[str, torch.Tensor]):
        ...
        # while True:
        #     continue
        # torch.tensor(np.load(f'/home/server33/minyeong_workspace/FL-bench/data/cifar10_niid3/raw/vq_centroid_client{self.client_id}.npy')).to(self.device)
