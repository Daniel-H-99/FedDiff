...
class FedDiffClient:
    ...
    def set_parameters(self, new_parameters: OrderedDict[str, torch.Tensor]):
        ...
        if True:
            ...
            label0 = torch.tensor(np.load(f'/home/server36/minyeong_workspace/FL-bench/data/organa_niid/raw/vq_centroid_label_client{self.client_id}.npy'))
            ...
            # self.model.base.model.private_context_generator.label_samples = np.arange(256)
            self.model.base.model.private_context_generator.label_samples = label0
