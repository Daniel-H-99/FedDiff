...
class FedDiffClient:
    ...
    def set_parameters(self, new_parameters: OrderedDict[str, torch.Tensor]):
        ...
        #     w0 = torch.tensor(np.load(f'/home/server31/minyeong_workspace/FL-bench/data/cifar10_niid3/raw/vq_centroid_client{self.client_id}.npy'))
        #     with torch.no_grad():
        #         w.copy_(w0)
        ...
        # while True:
        #     continue
        # torch.tensor(np.load(f'/home/server31/minyeong_workspace/FL-bench/data/cifar10_niid3/raw/vq_centroid_client{self.client_id}.npy')).to(self.device)
    ...
    def calc_fid(
        ...
        # fid_adv = self.model.evaluator.sample(self.model.base.sample_fn, self.label_dist[self.client_id], [f'/home/server31/minyeong_workspace/FL-bench/data/pathmnist/ref_fid_stats_pathmnist_client{self.client_id}.npz'], is_leader=True, adv=True, save_path=adv_save_path)['fid'][0]
        fid_local = self.model.evaluator.sample(self.model.base.sample_fn, self.label_dist[self.client_id], [f'/home/server31/minyeong_workspace/FL-bench/data/pathmnist/ref_fid_stats_pathmnist_client{self.client_id}.npz'], is_leader=True, save_path=local_save_path)['fid'][0]
        # fid_global = self.model.evaluator.sample(self.model.base.sample_fn, self.label_dist[self.client_id], [f'/home/server31/minyeong_workspace/FL-bench/data/pathmnist/ref_fid_stats_pathmnist.npz'], is_leader=True, save_path=global_save_path)['fid'][0]
        fid_adv = fid_local
    ...
    def test(
        ...
        fid_adv = self.model.evaluator.eval(self.model.base.sample_fn, self.label_dist[self.client_id], [f'/home/server31/minyeong_workspace/FL-bench/data/pathmnist/fid_stats_pathmnist_client{self.client_id}.npz'], is_leader=True, adv=True)['fid'][0]
        fid_local = self.model.evaluator.eval(self.model.base.sample_fn, self.label_dist[self.client_id], [f'/home/server31/minyeong_workspace/FL-bench/data/pathmnist/fid_stats_pathmnist_client{self.client_id}.npz'], is_leader=True, save_path=save_path)['fid'][0]
