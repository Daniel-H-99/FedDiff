...
true_image_dir = '/home/server36/minyeong_workspace/FL-bench/data/mnist_niid2/raw'

CID=0
def init_wandb():
    wandb.init(project='fids', name=f'twophase_mnist_niid2_client{CID}')
...
def main():
    ...
    ckpt_dir = f'/home/server36/minyeong_workspace/FL-bench/out_mnist_niid2_twophase_trial1/FedDiff/checkpoints'
    ...
    with open(f'tested_fid_twophase_mnist_niid2_client_{CID}.pkl', 'wb') as f:
        pkl.dump(fid_dict, f)
