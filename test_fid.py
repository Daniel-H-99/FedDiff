...
true_image_dir = '/home/server33/minyeong_workspace/FL-bench/data/cifar10_class0/raw'

CID=6
def init_wandb():
    wandb.init(project='fids', name=f'fed_cifar10_class0_client_{CID}')
...
def main():
    ...
    ckpt_dir = f'/home/server33/minyeong_workspace/FL-bench/out_cifar10_class0_fed_trial1/FedDiff/checkpoints'
    ...
    # with open(f'tested_fid_fed_cifar10_class0_client.pkl', 'wb') as f:
    #     pkl.dump(fid_dict, f)
