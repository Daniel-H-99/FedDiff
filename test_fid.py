...
def main():
    ...
    # cifar_src_path = '/home/server32/minyeong_workspace/ddpm-torch/images/eval/cifar10/cifar10_2040_ddim'
    # # cifar_src_path = '/home/server32/minyeong_workspace/ddpm-torch/tmp'
    # # cifar_tgt_path = '/home/server32/minyeong_workspace/FL-bench/data/cifar10/raw/all/train'
    # cifar_tgt_path = '/home/server32/minyeong_workspace/FL-bench/data/cifar10/raw/_all/train'
...
#     label_dist = {}
#     with open('/home/server32/minyeong_workspace/FL-bench/data/pathmnist/all_stats.json', 'r') as f:
#         d = json.load(f)
#         for k, v in d.items():
...
#     # fid_adv = eval.eval(base.sample_fn, self.label_dist[self.client_id], [f'/home/server32/minyeong_workspace/FL-bench/data/pathmnist/fid_stats_pathmnist_client{self.client_id}.npz'], is_leader=True, adv=True)['fid'][0]
#     fid_local = eval.eval(base.sample_fn, label_dist[client_id], [f'/home/server32/minyeong_workspace/FL-bench/data/pathmnist/fid_stats_pathmnist_client{client_id}.npz'], is_leader=True)['fid'][0]
