...
image_fid_dir = '/home/server33/minyeong_workspace/FL-bench/class0_images_fid'
true_image_dir = '/home/server33/minyeong_workspace/FL-bench/data/pathmnist_class0/raw'

CID=0
def init_wandb():
    wandb.init(project='fids', name=f'fed_class0_client_{CID}')
...
def main():
    ...
    ckpt_name_list = [os.path.join(ckpt_dir, f"pathmnist_class0_{f}_custom") for f in files if (f == 1600)]
    ...
    with open(f'tested_fid_fed_class0_client_tmp.pkl', 'wb') as f:
        pkl.dump(fid_dict, f)
    ...
    # with open(f'tested_privacy2_fed_client_{CID}.pkl', 'wb') as f:
    #     pkl.dump(privacy_dict, f)
